package com.pls.carrier.ws.domain;
...
public class CarrierCapacityCO implements Serializable {

	private static final long serialVersionUID = 2732952970020318312L;
	
	private static String DATE_FORMAT = "MM/dd/yyyy HH:mm";
	...
	/**
	 * @return the availableDateTime
	 */
	public Date getAvailableDateTime() {
		try {
			return DateUtility.stringToDate(availableDate, DATE_FORMAT);
	...
	/**
	 * @param availableDateTime the availableDateTime to set
	 */
	public void setAvailableDateTime(Date availableDateTime) {
		this.availableDate = DateUtility.dateToString(availableDateTime, DATE_FORMAT);
	}
